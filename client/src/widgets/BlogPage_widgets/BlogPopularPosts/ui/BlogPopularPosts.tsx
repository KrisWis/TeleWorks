...
import { blogPopularPosts } from "../model/BlogPopularPosts_data";
import { BlogPopularPost } from "./BlogPopularPost/ui/BlogPopularPost";
import "./BlogPopularPosts_swiper.scss";

export const BlogPopularPosts: React.FC = memo((): React.JSX.Element => {
  return (
    <Flex
      direction="column"
      className={`BlogPopularPosts ${styles.BlogPopularPosts}`}
    >
