...
export const MarketPlaceSlider_items: MarketPlaceSlider_item_props[] = [
  {
    imgURL: `${URL_PART}/InternalPage/images/MarketPlaceAuthor_img.png`,
    authorName: "Имя",
    authorSurname: "Фамилия",
