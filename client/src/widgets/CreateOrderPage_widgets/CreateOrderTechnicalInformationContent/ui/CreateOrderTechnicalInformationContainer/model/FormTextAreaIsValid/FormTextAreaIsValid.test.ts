import { FormTextAreaIsValid } from "./FormTextAreaIsValid";

describe("FormTextAreaIsValid", () => {
  test("with empty string", () => {
    expect(FormTextAreaIsValid("")).toBe(false);
  });

  test("with less than min string", () => {
    expect(FormTextAreaIsValid("ewww")).toBe(false);
  });

  test("with more than max string", () => {
    expect(
      FormTextAreaIsValid(`Что такое Lorem Ipsum?
