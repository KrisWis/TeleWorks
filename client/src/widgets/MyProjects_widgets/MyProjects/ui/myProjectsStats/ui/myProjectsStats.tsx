import styles from "./myProjectsStats.module.scss";
import { memo } from "react";
import { myProjectsStatsProps } from "../model/myProjectsStats_types";
import { Link } from "react-router-dom";

export const MyProjectsStats: React.FC<myProjectsStatsProps> = memo(
  ({
    allAmount,
    queueAmount,
    inWorkAmount,
        ...
        <ul className={styles.myProjects__stats__items}>
          <li className={styles.myProjects__stats__item}>
            <div className={styles.myProjects__stats__item__title}>
              ...
              <span className={styles.myProjects__stats__item__type}>Все</span>
            </div>

            <span className={styles.myProjects__stats__item__amount}>
              {allAmount}
            </span>
          </li>
