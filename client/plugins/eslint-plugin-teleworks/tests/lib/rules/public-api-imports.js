...
ruleTester.run("public-api-imports", rule, {
  ...
  invalid: [
    ...
    {
      filename:
        "C:\\Users\\tim\\Desktop\\javascript\\production_project\\src\\entities\\widgets\\forbidden.ts",
      code: "import { addCommentFormActions, addCommentFormReducer } from '@/entities/widgets/Article/testing'",
      errors: [
        {
          message:
