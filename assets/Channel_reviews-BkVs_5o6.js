...
`,Tt={value:function(n){var e=n.props,t=Math.max(e.value,2),r=e.value?e.color:"transparent";return e.mode==="indeterminate"?{backgroundColor:e.color}:{width:t+"%",display:"flex",backgroundColor:r}}},U=E.extend({defaultProps:{__TYPE:"ProgressBar",__parentMetadata:null,id:null,value:null,showValue:!0,unit:"%",style:null,className:null,mode:"determinate",displayValueTemplate:null,color:null,children:void 0},css:{classes:Ct,styles:Ot,inlineStyles:Tt}});function Se(a,n){var e=Object.keys(a);if(Object.getOwnPropertySymbols){var t=Object.getOwnPropertySymbols(a);n&&(t=t.filter(function(r){return Object.getOwnPropertyDescriptor(a,r).enumerable})),e.push.apply(e,t)}return e}function At(a){for(var n=1;n<arguments.length;n++){var e=arguments[n]!=null?arguments[n]:{};n%2?Se(Object(e),!0).forEach(function(t){Pt(a,t,e[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(a,Object.getOwnPropertyDescriptors(e)):Se(Object(e)).forEach(function(t){Object.defineProperty(a,t,Object.getOwnPropertyDescriptor(e,t))})}return a}var ke=w.memo(w.forwardRef(function(a,n){var e=it(),t=w.useContext(de),r=U.getProps(a,t),i=U.setMetaData(At({props:r},r.__parentMetadata)),o=i.ptm,s=i.cx,l=i.isUnstyled;xt(U.css.styles,l,{name:"progressbar"});var u=w.useRef(null),f=function(){if(r.showValue&&r.value!=null){var y=r.displayValueTemplate?r.displayValueTemplate(r.value):r.value+r.unit;return y}return null},p=function(){var y=f(),m=e({className:H(r.className,s("root")),style:r.style,role:"progressbar","aria-valuemin":"0","aria-valuenow":r.value,"aria-valuemax":"100"},U.getOtherProps(r),o("root")),b=e({className:s("value"),style:{width:r.value+"%",display:"flex",backgroundColor:r.color}},o("value")),v=e({className:s("label")},o("label"));return w.createElement("div",J({id:r.id,ref:u},m),w.createElement("div",b,y!=null&&w.createElement("div",v,y)))},d=function(){var y=e({className:H(r.className,s("root")),style:r.style,role:"progressbar","aria-valuemin":"0","aria-valuenow":r.value,"aria-valuemax":"100"},U.getOtherProps(r),o("root")),m=e({className:s("container")},o("container")),b=e({className:s("value"),style:{backgroundColor:r.color}},o("value"));return w.createElement("div",J({id:r.id,ref:u},y),w.createElement("div",m,w.createElement("div",b)))};if(w.useImperativeHandle(n,function(){return{props:r,getElement:function(){return u.current}}}),r.mode==="determinate")return p();if(r.mode==="indeterminate")return d();throw new Error(r.mode+" is not a valid mode for the ProgressBar. Valid values are 'determinate' and 'indeterminate'")}));ke.displayName="ProgressBar";const V=({stars_amount:a,progress_amount:n})=>{const e=Array(a).fill("active"),t=Array(5-a).fill("disactive");return C.jsxs("div",{className:B.channel_reviews__starsWrapper,children:[C.jsxs("div",{className:B.channel_reviews__starsWrapper__stars,children:[e.map((r,i)=>C.jsx("img",{className:B.channel_reviews__starsWrapper__star,src:`${ge}/ProfilePage/icons/channel_reviews__item/channel_reviews__item_star_active.png`,alt:"Изображение активной звезды"},r+i)),t.map((r,i)=>C.jsx("img",{className:B.channel_reviews__starsWrapper__star,src:`${ge}/ProfilePage/icons/channel_reviews__item/channel_reviews__item_star_disactive.png`,alt:"Изображение пустой звезды"},r+i))]}),C.jsx(ke,{"aria-labelledby":`Рейтинг канала в ${a} звёздах`,className:B.channel_reviews__starsWrapper__progressbar,value:n,showValue:!1})]})},kt="_channel_reviews_5id6q_1",Nt="_channel_reviews__caption_5id6q_6",Ft="_channel_reviews__wrapper_5id6q_15",jt="_channel_reviews__marks_5id6q_26",It="_channel_reviews__marks_amount_5id6q_30",Wt="_channel_reviews__mark_5id6q_26",Lt="_channel_reviews__stars_5id6q_48",L={channel_reviews:kt,channel_reviews__caption:Nt,channel_reviews__wrapper:Ft,channel_reviews__marks:jt,channel_reviews__marks_amount:It,channel_reviews__mark:Wt,channel_reviews__stars:Lt},Ht=()=>C.jsxs("section",{className:L.channel_reviews,children:[C.jsx("h2",{className:L.channel_reviews__caption,children:"Отзывы канала"}),C.jsxs("div",{className:L.channel_reviews__wrapper,children:[C.jsxs("div",{className:L.channel_reviews__marks,children:[C.jsx("span",{className:L.channel_reviews__mark,children:"5.0"}),C.jsx("span",{className:L.channel_reviews__marks_amount,children:"484 оценки"})]}),C.jsxs("div",{className:L.channel_reviews__stars,children:[C.jsx(V,{stars_amount:5,progress_amount:100}),C.jsx(V,{stars_amount:4,progress_amount:80}),C.jsx(V,{stars_amount:3,progress_amount:0}),C.jsx(V,{stars_amount:2,progress_amount:0}),C.jsx(V,{stars_amount:1,progress_amount:0})]})]})]});export{Ht as Channel_reviews};
