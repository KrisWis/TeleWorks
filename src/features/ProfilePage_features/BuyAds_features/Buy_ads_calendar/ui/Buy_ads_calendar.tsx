...
export const Buy_ads_calendar: React.FC = (): React.JSX.Element => {
    ...
    useEffect(() => {
        ...
        const calendar_prevButton: HTMLElement | null = document.querySelector(".react-calendar__navigation__prev-button");
        const calendar_nextButton: HTMLElement | null = document.querySelector(".react-calendar__navigation__next-button");

        if (calendar_prevButton) {
            calendar_prevButton.innerHTML =
