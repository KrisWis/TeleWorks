    ...
    return (
      <div className={`${styles.categories} categories`}>
        {categories.length >= 5 ? (
          <>
            <svg
              id={`${categories[0]}categories_prevArrow`}
            ...
            <Swiper
              navigation={{
                prevEl: `#${categories[0]}categories_prevArrow`,
                nextEl: `#${categories[0]}categories_nextArrow`,
              }}
              modules={[Navigation]}
              spaceBetween={60}
              slidesPerView={5.2}
            ...
            <svg
              id={`${categories[0]}categories_nextArrow`}
