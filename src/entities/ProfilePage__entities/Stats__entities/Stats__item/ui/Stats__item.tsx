    ...
    return (
        <div className={styles.stats__item}>
            ...
            <div className={styles.stats__item__stats__graphics}>
                ...
                <h4 className={styles.stats__item__stats__graphics__caption}>{caption}</h4>

                <img className={styles.stats__item__stats__graphics__img} src={graphic_imgURL} alt="Изображение графика" />
