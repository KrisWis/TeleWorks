import styles from "./Similar_channels__header.module.scss";

export const Similar_channels__header: React.FC = (): React.JSX.Element => {
  return (
    <div className={styles.similar_channels__header}>
      <h2 className={styles.similar_channels__caption}>Похожие каналы</h2>

      <div className={styles.similar_channels__arrows}>
        <div
          className={styles.similar_channels__arrow}
          id="similar_channels_prevArrow"
        >
          <svg
            width="25"
            height="18"
