...
export const Buy_ads: React.FC = (): React.JSX.Element => {
    ...
    // TODO: сделать из формы отдельный компонент, добавить шрифты
        ...
        <section className={styles.buy_ads}>
            ...
            <div className={styles.buy_ads__form}>
                ...
                <div className={styles.buy_ads__form__price}>
                    ...
                    <span className={styles.buy_ads__form__price__span}>Cтоимость публикации :</span>
