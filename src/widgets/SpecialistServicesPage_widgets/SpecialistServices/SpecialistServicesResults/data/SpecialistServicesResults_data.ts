...
export const servicesItems: ServicesItem[] = [
  {
    imgURLs: [
      `${URL_PART}/SpecialistServicesPage/images/serviceExample_img.png`,
    ],
    title: "Инфографика для маркетплейсов.",
    TeleWorksChoice: true,
    price: "от 3 000 ₽",
    authorName: "Роман Б.",
    authorImgURL: `${URL_PART}/SpecialistServicesPage/images/serviceExample_authorImg.png`,
  ...
  {
    imgURLs: [
      `${URL_PART}/SpecialistServicesPage/images/serviceExample_img_2.png`,
    ],
