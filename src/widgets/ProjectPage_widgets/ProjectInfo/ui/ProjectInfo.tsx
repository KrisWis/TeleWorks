...
import { ProjectInfo_packs } from "../model/ProjectInfo_data";

export const ProjectInfo: React.FC = memo((): React.JSX.Element => {
  ...
  return (
    <section className={styles.projectInfo}>
      <div className={styles.projectInfo__header}>
        <h2 className="ProjectPage__subcaption">
        ...
        <div className={styles.projectInfo__icons}>
          <div className={styles.projectInfo__favourite}>
            ...
            <span className={styles.projectInfo__favouriteAmount}>545</span>
          </div>
      ...
      <div className={`${styles.projectInfo__breadcrumbs} ProjectPage__span`}>
        <span>Дизайн</span>
        <span className={styles.projectInfo__breadcrumbs__separator}>&gt;</span>
      ...
      <div className={styles.projectInfo__author}>
        ...
        <div className={styles.projectInfo__authorInfo}>
          <span className={styles.projectInfo__authorName}>Роман Б.</span>
          ...
          <div className={styles.projectInfo__authorRating}>
            ...
            <span className={styles.projectInfo__authorRatingNumber}>5.0</span>
