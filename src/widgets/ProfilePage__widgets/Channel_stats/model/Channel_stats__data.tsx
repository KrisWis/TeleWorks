...
export const channel_stats__items: Channel_stats_item_props[] = [
  {
    imgURL: `${URL_PART}/images/Channel_stats/Channel_stats_rating.png`,
    caption: "Рейтинг",
    amount: "509.2",
  },

  {
    imgURL: `${URL_PART}/images/Channel_stats/Channel_stats_requests.png`,
    caption: "Выполнено заявок",
    amount: "102",
  },

  {
    imgURL: `${URL_PART}/images/Channel_stats/Channel_stats_stars.png`,
