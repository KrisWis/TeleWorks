import { Platrform_Privileges__itemProps } from "@/entities/MainPage__entities/Platform_Privileges__entities/Platform_Privileges__item/model/Platform_Privileges__item__types";
